...
namespace {
  ...
  class BondHarmonicTest : public ::testing::Test {   
  protected:
    BondHarmonicTest() {
      char *argv[] = {"bond_harmonic", "-screen", "none", "-log", "none", NULL};
 ...
 TEST_F(BondHarmonicTest, Coeff_CorrectNarg){
    lmp->force->bond = new BondHarmonic(lmp);
    char *bcoeff_argv[] = {"1", "100.0", "2.5", NULL};
    int bcoeff_narg; 
 ...
 TEST_F(BondHarmonicTest, Coeff_highNarg){
    lmp->force->bond = new BondHarmonic(lmp);
    char *bcoeff_argv[] = {"1", "100.0", "2.5", NULL};
    int bcoeff_narg; 
 ...
 TEST_F(BondHarmonicTest, Coeff_lowNarg){
    lmp->force->bond = new BondHarmonic(lmp);
    char *bcoeff_argv[] = {"1", "100.0", "2.5", NULL};
    int bcoeff_narg; 
  ...
  TEST_F(BondHarmonicTest,Coeff_NegativeNarg){
    lmp->force->bond = new BondHarmonic(lmp);
    char *bcoeff_argv[] = {"1", "100.0", "2.5", NULL};
    int bcoeff_narg; 
 ...
 //////////////////////////////////////////////////////////////////////
  ...
  // Test basic case with 2 atoms & 1 bond & coeff_argv{1, k = 132.0, r_0 = 2.0}
  TEST_F(BondHarmonicTest, Bond1Run0_1) {
    // Variables for test
    double k = 132.0;
    double r0 = 2.0;
    double atomNum = 2; 
    ...
    lmp->force->bond = new BondHarmonic(lmp);
    char *bcoeff_argv[] = {"1", "132.0", "2.0", NULL};
    int bcoeff_narg; 
  ...
  // Test basic case with 2 atoms & 1 bond & coeff_argv{1, k = 500.0, r_0 = 10.0}
  TEST_F(BondHarmonicTest, Bond1Run0_2) {
    // Variables for test
    double k = 500.0;
    double r0 = 10.0;
    double atomNum = 2; 
    ...
    lmp->force->bond = new BondHarmonic(lmp);
    char *bcoeff_argv[] = {"1", "500.0", "10.0", NULL};
    int bcoeff_narg; 
  ...
  // Test basic case with 4 atoms & 2 bond & coeff_argv{1, k = 100.0, r_0 = 1.0}
  TEST_F(BondHarmonicTest, Bond2Run0_1) {     
    // Variables for run 
    double k = 100.0;
    double r0 = 1.0;
    double atomNum = 4; 
    ...
    double dr1 = r1 - r0;
    double rk1 = k*dr1; 
    double fbond1 = -2.0*(rk1/r1);
    double ebond1 = rk1*dr1;
    ...
    double dr2 = r2 - r0;
    double rk2 = k*dr2; 
    double fbond2 = -2.0*(rk2/r2);
    double ebond2 = rk2*dr2;
    ...
    lmp->force->bond = new BondHarmonic(lmp);
    //  k = 100.0 and r0 = 1
    char *bcoeff_argv[] = {"1", "100.0", "1", NULL};
    int bcoeff_narg; 
  ...
  // Test basic case with 4 atoms & 2 bond & coeff_argv{1, k = 50.0, r_0 = 5.0}
  TEST_F(BondHarmonicTest, Bond2Run0_2) {     
    // Variables for run 
    double k = 50.0;
    double r0 = 5.0;
    double atomNum = 4; 
    ...
    lmp->force->bond = new BondHarmonic(lmp);
    //  k = 50.0 and r0 = 5
    char *bcoeff_argv[] = {"1", "50.0", "5", NULL};
    int bcoeff_narg; 
  ...
  // Test basic case with 4 atoms & 3 bond & coeff_argv{1, k = 100.0, r_0 = 1.0}
  TEST_F(BondHarmonicTest, Bond3Run0_1) {     
    // Variables for run 
    double k = 100.0;
    double r0 = 1.0;
    double atomNum = 4; 
    ...
    double dr3 = r3 - r0;
    double rk3 = k*dr3; 
    double fbond3 = -2.0*(rk3/r3);
    double ebond3 = rk3*dr3;
  ...
  // Test basic case with 4 atoms & 3 bond & coeff_argv{1, k = 50.0, r_0 = 5.0}
  TEST_F(BondHarmonicTest, Bond3Run0_2) {     
    // Variables for run 
    double k = 50.0;
    double r0 = 5.0;
    double atomNum = 4; 
